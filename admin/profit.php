                ...
                <div id="page-inner">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!--End Advanced Tables -->
                            <div class="panel-body">
                                <a href="profitroom.php"><button  width="500px" class="btn btn-primary btn" >
                                    Room Booking - Profit Report
                                </button>
                                </a>
                               
                            </div>
                            <div class="panel-body">
                            <a href="profithall.php"><button class="btn btn-primary btn" >
                                Banquate Booking - Profit Report
                                </button>
                                </a>
                               
                            </div>
                            <div class="panel-body">
                            <a href="profitcafe.php"><button class="btn btn-primary btn" >
                                Cafetaria Booking - Profit Report
                                </button>
                                </a>
                            </div>
                            <div class="panel-body">
                            <a href="profitpool.php"><button class="btn btn-primary btn" >
                                Swimming Pool Booking - Profit Report
                                </button>
                                </a>
                            </div>
