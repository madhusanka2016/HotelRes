        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="payment.php"><i class="fa fa-qrcode"></i>Payment for Rooms</a>
                    </li>
                    <li>
                        <a class="active-menu"  href="banquetPayment.php"><i class="fa fa-qrcode"></i>Payment for Banquet halls</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Banquet Payment Details<small> </small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										include ('db.php');
										$sql="select * from banquetpayment";
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
													...
													<td>".$row['btot']."</td>
													<td>".$row['fintot']."</td>
													<td><a href=banquetPrint?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
													</tr>";
											}
											else
											{
