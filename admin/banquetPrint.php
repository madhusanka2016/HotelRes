...
@page { margin: 0; }
	...
	$sql ="select * from banquetpayment where id = '$pid' ";
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$fintot = $row['fintot'];
									...
									else if($hall=="Merigold")
									{
										$type_of_hall = 220;
									}
									else if($hall=="Citadel")
									{
										$type_of_hall = 180;
									}
									else if($hall=="Victorian Lobby")
									{
										$type_of_hall = 150;
									}
									...
									if($light=="Stage Only")
									{
										$type_of_light =$type_of_bed * 0;
									}
									else if($light=="Color Changing")
									{
										$type_of_light =$type_of_bed * 2;
									}else if($light=="Half Board")
									{
										$type_of_light =$type_of_bed * 3;
									
									}else if($light=="Full Board")
									{
										$type_of_light =$type_of_bed * 4;
									}
	...
	?>
		<header>
			...
			<address >
				...
				<p>Horton Plain Road,<br>Nuwaraeliya,<br>Sri Lanka.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>$</span><span ><?php  echo $type_of_hall;?></span></td>
					...
					<tr>
						...
						<td><span data-prefix>$</span><span ><?php  echo $type_of_light?></span></td>
...
$free="Free";
$nul = null;
$rpsql = "UPDATE `banquet` SET `place`='$free',`cusid`='$nul' where `cusid`='$id'";
if(mysqli_query($con,$rpsql))
{
	$delsql= "DELETE FROM `banquetbook` WHERE id='$id' ";
