...
<?php
$sql = "select * from banquetpayment where cindate like '$range%'  ";
...
?>
                <header>
                    <h1><center>Profit Report - Banquet Hall Booking</center></h1>
		...
		<article>
                                                    ...
                                                    <a href="profit_rephallprint.php?id=<?php echo $range?>";><button class="btn academy-btn mt-30" >Print</button> </a>
                                                </div>
                                            </div>
                                            <!--End Advanced Tables -->
                                        </div>
