        ...
        <div class="row" style="margin-top: 150px">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><button class="btn btn-default form-control" onclick="location.href='banquetReservation.php'"><span class="badge pull-right"><span class="glyphicon glyphicon-remove"></span></span>Cancel</button>
                        </li>
                    </ul>
                    <br/>
                        <div class="col-md-4">
