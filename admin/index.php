...
<head>
  <meta charset="UTF-8">
  <title>HORTAIN RISE ADMIN</title>
...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">HORTAIN RISE LOGIN</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id, active FROM login WHERE usname = '$myusername' and pass = '$mypassword'";
